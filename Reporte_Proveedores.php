...
$pdf-> Cell(18,8,'Telefono',0);
$pdf-> Ln(8);
$pdf-> SetFont("Arial",'',8);
//Consulta
$nueva='SELECT * FROM  proveedor';
$resultado = $connect->query($nueva);
$fila=mysqli_fetch_assoc($resultado);
do
{
   
	$pdf->Cell(10,8,$fila['ID_PROVEEDOR'],0);
	$pdf->Cell(25,8,$fila['NOMBRE'],0);
	$pdf->Cell(30,8,$fila['APELLIDO'],0);
	$pdf->Cell(20,8,$fila['CEDULA'],0);
	$pdf->Cell(22,8,$fila['RUC'],0);
    $pdf->Cell(40,8,$fila['DIRECCION'],0);
    $pdf->Cell(18,8,$fila['TELEFONO'],0);
   $pdf->Ln(8);
